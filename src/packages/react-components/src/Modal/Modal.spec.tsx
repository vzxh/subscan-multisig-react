...
function TestModal() {
  ...
  return (
    <>
      <Button icon="plus" isDisabled={false} label="Open Test Modal" onClick={toggleIsOpen} />
      {isOpen && (
        <Modal header="Test Modal" onClose={toggleIsOpen} testId="test-modal">
          <Modal.Content>Test Modal Content</Modal.Content>
          <Modal.Actions>
            <Button icon="plus" label="Submit Modal" />
          </Modal.Actions>
        </Modal>
      )}
    </>
