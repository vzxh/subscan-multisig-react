...
function SortDropdown({
  ...
  return (
    <div className={`ui--Sort ${className}`}>
      <Dropdown defaultValue={defaultValue} label={label} onChange={onChange} options={options} />
      <button onClick={onClick}>
        <Icon className={`arrow up${sortDirection === 'ascending' ? ' isActive' : ''}`} color="gray" icon="sort-up" />
        <Icon
